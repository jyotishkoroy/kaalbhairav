...
export function guardOneShotAstroQuestion(question: string): AstroQuestionGuardResult {
  ...
  if (!hasMeaningfulAsciiLetter(normalized) || normalized.length < 2) return { allowed: false, code: "malformed_question", answer: "aadesh: Please enter a clear English question to receive guidance." };
