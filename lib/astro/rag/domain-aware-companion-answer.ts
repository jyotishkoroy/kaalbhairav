...
const DOMAINS: Domain[] = [
  ...
  { id: "misunderstood_intentions", patterns: [/\b(misunderstood|people misread|intentions misread|they think i am|judged wrongly|no one understands? me)\b/i, /\b(father|mother|parent|family) (never|doesn.?t|don.?t) understand(s)?\b/i] },
