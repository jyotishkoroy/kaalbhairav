...
export function routeStructuredIntent(input: StructuredIntentInput): StructuredIntent {
  ...
  if (hasAny(q, ["can my chart tell when i will die", "how long will i live", "is there danger to my life this year", "is there a death period in my chart", "can astrology predict accidents exactly", "danger to my life", "dangerous for my health", "accident timing"])) return buildIntent("death_lifespan", "safety", "high", resolved.routedFrom);
  if (hasAny(q, ["should i stop medical treatment and use mantra only", "can astrology diagnose my disease", "is this year dangerous for my health", "insomnia caused by planets"])) return buildIntent("health_adjacent", "safety", "high", resolved.routedFrom);
  ...
  if (hasAny(q, ["what remedy can i do without spending money", "without spending money", "give me remedy for bad sleep", "i cannot sleep and feel mentally restless", "remedy", "puja", "mantra", "gemstone", "spiritual practice"])) return buildIntent("remedy", "remedy", "high", resolved.routedFrom);
  if (hasAny(q, ["can astrology guarantee business profit", "can you guarantee business profit this year", "business profit", "profit in business", "startup profit", "partnership profit", "risky financial opportunity"])) return buildIntent("business", "safety", "high", resolved.routedFrom, ["financial_risk"]);
  ...
  if (hasAny(q, ["should i focus on job, business, or study", "i am confused between job business and study", "i am confused between job, business, and study", "job, business, and study", "job business study"])) return buildIntent("mixed", "follow_up", "high", resolved.routedFrom, ["job", "business", "study"]);
