...
## Corpus Check
- 714 files · ~734,229 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3300 nodes · 6511 edges · 63 communities detected
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 1240 edges (avg confidence: 0.8)
...
- `allTrueConsultationFlags()` --calls--> `resolveConsultationFeatureFlags()`  [INFERRED]
  tests/astro/consultation/consultation-production-wrapper.test.ts → lib/astro/consultation/consultation-feature-flags.ts
...
Cohesion: 0.01
Nodes (204): approveDraft(), approvePost(), cleanSlug(), createPost(), deleteAccount(), deletePost(), geocode(), publishPost() (+196 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (142): onSubmit(), makeRequest(), makeRequest(), makeRequest(), makeRequest(), createRequest(), makeReq(), request() (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (105): calculateGrahaDrishti(), calculateAyanamsa(), getAstroEngineBackend(), getAstroEngineServiceApiKey(), getAstroEngineServiceUrl(), isRemoteAstroEngineConfigured(), nearNakshatraBoundary(), nearNavamsaBoundary() (+97 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (103): buildDeterministicAnalyzerResult(), isObject(), normalizeAnalyzerResult(), normalizeBoolean(), normalizeConfidence(), normalizeFollowupQuestion(), normalizeQuestionType(), normalizeSource() (+95 more)
...
Cohesion: 0.06
Nodes (62): answerCanonicalAstroQuestion(), ensureChartGroundedAnswer(), stripMetadata(), basisFor(), buildAstroAnswerPlan(), houseOf(), ord(), planetDesc() (+54 more)
...
Cohesion: 0.05
Nodes (37): allTrueConsultationFlags(), baseOrchestratorResult(), syntheticEvidence(), createDefaultConsultationIntent(), createDefaultCulturalFamilyContext(), createDefaultEmotionalState(), createDefaultFollowUpState(), createDefaultLifeStory() (+29 more)
...
Cohesion: 0.11
Nodes (52): applyContextToState(), enrichStateForOutput(), getSessionId(), hasAnyChartEvidence(), inferEvidenceDomain(), inferRequestedRemedyType(), mergeStateFromMemory(), normalizeQuestion() (+44 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (46): getConsultationFallbackMode(), parseConsultationFlagValue(), resolveConsultationFeatureFlags(), resolveConsultationFeatureFlagValues(), bucketResponseLength(), buildConsultationMonitoringAggregateReport(), buildConsultationMonitoringEvent(), containsAny() (+38 more)
...
Cohesion: 0.08
Nodes (35): buildCase(), buildQuestion(), generateQuestionBankRecords(), slugify(), summarizeQuestionBank(), getRequestContext(), handleAstroV2ReadingRequest(), inferQuestionMode() (+27 more)
...
Cohesion: 0.1
Nodes (29): evaluateAstroAnswerQuality(), evaluateExactFactAnswer(), evaluateInaccurateAnswer(), evaluateInterpretiveAnswer(), extractExpectedFactTokens(), getAnswerSimilarityKey(), normalizeAnswerForSimilarity(), normalizeAstroFactText() (+21 more)

### Community 29 - "Community 29"
Cohesion: 0.23
Nodes (34): addFact(), asNumber(), asString(), buildStructuredRuleRankingContext(), extractBirthFacts(), extractChartFactsFromVersion(), extractDashaFacts(), extractExplicitRelations() (+26 more)
...
- **Thin community `Community 72`** (3 nodes): `MockRecognition`, `setWindow()`, `browser-speech.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (3 nodes): `makeResolvedChain()`, `makeServiceMock()`, `diagnose-and-repair-current-chart.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 81`** (3 nodes): `vector-retrieval.ts`, `fetchVectorReasoningRuleCandidates()`, `isAstroVectorRetrievalEnabled()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (2 nodes): `Editable install root for astro_calculation_engine.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `stringify()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 26`, `Community 28`, `Community 31`, `Community 36`, `Community 43`, `Community 45`?**
  _High betweenness centrality (0.309) - this node is a cross-community bridge._
- **Why does `has()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 23`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 48`?**
  _High betweenness centrality (0.254) - this node is a cross-community bridge._
- **Why does `GET()` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 35`, `Community 10`, `Community 43`, `Community 11`, `Community 45`, `Community 15`, `Community 17`, `Community 22`, `Community 28`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Are the 110 inferred relationships involving `stringify()` (e.g. with `buildAnalyzePrompt()` and `buildCriticPrompt()`) actually correct?**
  _`stringify()` has 110 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 41 inferred relationships involving `POST()` (e.g. with `createClient()` and `isE2ERateLimitDisabled()`) actually correct?**
