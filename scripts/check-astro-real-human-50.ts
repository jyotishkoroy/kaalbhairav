...
const CASES: CaseExpectation[] = [
  ...
  { number: 7, id: "current_antardasha", category: "timing", prompt: "Which Antardasha should be active around 2026 according to my report?", mode: "practical_guidance", requiresTrace: true, requiresSupabase: true, requiresOracle: "optional", allowGroq: true, allowOllama: false, allowFallback: true, mustContainAny: ["Jupiter/Ketu", "Jupiter/Venus", "2026"], mustNotContainAny: ["guaranteed"], expectedTrace: { safetyRan: true, finalComposerRan: true, finalValidatorPassed: true, supabaseLoaded: true } },
