...
describe("buildVedicStyleAnswer", () => {
  ...
  it("covers relationship and finance", () => {
    expect(buildVedicStyleAnswer({ question: "What kind of partner suits me?", topic: "relationship", facts })).toContain("conversation");
