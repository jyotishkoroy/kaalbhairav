...
describe("structured intent router", () => {
  ...
  it("routes risky financial opportunity to business safety", () => expect(route("Should I trust a risky financial opportunity because of my chart?")).toMatchObject({ primaryIntent: "business", mode: "safety" }));
  ...
  it("routes risky opportunity to business safety", () => expect(route("Should I take a risky financial opportunity?")).toMatchObject({ primaryIntent: "business", mode: "safety" }));
  ...
  it("routes leave india immediately for success to foreign safety", () => expect(route("Should I leave India immediately for success?")).toMatchObject({ primaryIntent: "foreign", mode: "safety" }));
  ...
  it("routes dangerous for my health to death lifespan safety", () => expect(route("Is this year dangerous for my health?")).toMatchObject({ primaryIntent: "death_lifespan", mode: "safety" }));
